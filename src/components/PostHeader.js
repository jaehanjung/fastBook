    ...
    <h1 className="title">
        ...
        <svg className="svg">
            <g style={htmlStyle}>
                ...
                <path d="M16.938,23.381h-2.824l5.884-22.948h2.354l5.884,22.948h-2.824l-1.648-6.708h-5.178L16.938,23.381z
M21.293,6.67h-0.235l-1.883,7.767h4.001L21.293,6.67z" />
                <path d="M39.769,12.554c1.804,1.02,2.707,2.512,2.707,4.472c0,1.961-0.588,3.531-1.765,4.707
...
c0,1.02,0.548,2.001,1.648,2.942C36.474,10.435,38.121,11.612,39.769,12.554z" />
                ...
                <path d="M70.485,1.845c1.177,1.177,1.765,2.589,1.765,4.237c0,1.491-0.432,2.668-1.295,3.531
...
c0.783-0.783,1.177-1.804,1.177-3.06c0-1.412-0.432-2.549-1.295-3.413c-0.941-0.941-1.883-1.412-2.824-1.412H62.953z" />
                <path d="M87.902,11.848c0,4.943-0.864,8.278-2.589,10.003c-1.02,1.02-2.314,1.53-3.884,1.53
...
c-0.864,0-1.648,0.353-2.354,1.059C78.056,4.747,77.546,7.454,77.546,11.848z" />
                <path d="M102.966,11.848c0,4.943-0.864,8.278-2.589,10.003c-1.02,1.02-2.314,1.53-3.884,1.53
c-1.648,0-2.983-0.51-4.001-1.53c-1.726-1.725-2.589-5.06-2.589-10.003c0-4.864,0.863-8.159,2.589-9.885
...
c-0.864,0-1.648,0.353-2.354,1.059C93.119,4.747,92.609,7.454,92.609,11.848z" />
                <path d="M105.437,23.381V0.432h2.707v9.65l6.708-9.65h3.177l-6.237,9.062l6.708,13.887h-3.06l-5.413-11.651
        ...
        <h2 className="blind">사용자 메뉴</h2>
           <ul className="header-menu__btns">
                ...
                <div className="header-menu__search">
                    <label htmlFor="inpSearch" className="fas fa-search">
                        <span className="blind">메모 검색</span>
                    </label>
                    <input type="text" id="inpSearch" name="inpSearch" className="header-menu__search-input" placeholder="Search for text..." value="" />>
